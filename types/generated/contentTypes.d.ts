...
export interface ApiCompanyImageCompanyImage extends Struct.SingleTypeSchema {
  collectionName: 'company_images';
  info: {
    displayName: 'Company Image';
    pluralName: 'company-images';
    singularName: 'company-image';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::company-image.company-image'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCompanyLogoCompanyLogo extends Struct.SingleTypeSchema {
...
export interface ApiCompanyMissionCompanyMission
  extends Struct.SingleTypeSchema {
  collectionName: 'company_missions';
  info: {
    displayName: 'Company Mission';
    pluralName: 'company-missions';
    singularName: 'company-mission';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    companyMission: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::company-mission.company-mission'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCompanyVisionCompanyVision extends Struct.SingleTypeSchema {
  collectionName: 'company_visions';
  info: {
    displayName: 'Company Vision';
    pluralName: 'company-visions';
    singularName: 'company-vision';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    CompanyVision: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::company-vision.company-vision'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiContactEmailContactEmail extends Struct.SingleTypeSchema {
...
export interface ApiFacebookFacebook extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facebookId: Schema.Attribute.String & Schema.Attribute.Required;
    facebookLogo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['Report', 'Notice']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSubheadingSubheading extends Struct.SingleTypeSchema {
  collectionName: 'subheadings';
  info: {
    displayName: 'Subheading';
    pluralName: 'subheadings';
    singularName: 'subheading';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTikTokTikTok extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    TiktokId: Schema.Attribute.String & Schema.Attribute.Required;
    TiktokLogo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::company-image.company-image': ApiCompanyImageCompanyImage;
      'api::company-logo.company-logo': ApiCompanyLogoCompanyLogo;
      'api::company-mission.company-mission': ApiCompanyMissionCompanyMission;
      'api::company-vision.company-vision': ApiCompanyVisionCompanyVision;
